984532 -0.036117  0xba5f4f92f396e6de20d3dae5eefa65f4ecca806a  Open Short   
984533 -0.206146  0x5483dd0f8b7d2544a6ac14ba8659988178fd9f4a  Open Short   
...
**Output:**
```
Rows: 984,534  (492,267 taker / 492,267 maker)
Unique tids: 492,267   well-formed: 492,267  (100.0000%)
```
...
# SOL perp at ~$93: 5 sig.figs & ≤4 decimals → tick = $0.001. Lot = 0.01 SOL.
TICK   = 0.001
LEVELS = 20
THEME  = 'plotly_dark'
...
**Output:**
```
LOB:   778,444 snapshots,  2026-04-01 00:00:12.017000 → 2026-04-05 23:59:58.087000
Taker: 492,267 fills (= unique trades)
```
...
LOB snapshots                                        778,444
Median snap Δt                                        537 ms
Taker fills                                          492,267
Trade rate                                         1.14 /sec
Maker fills with rebate                               69.3 %
Mid range                                  $76.69  /  $86.56
Mean spread                           1.31 ticks  (0.16 bps)
```
...
```python
SPREAD_X_MAX = 10   # граница справа на первых двух графиках; увеличь чтобы увидеть хвост
...
![fig_03_spread_x_max_10_граница_справа_на_первых.png](fig_03_spread_x_max_10_граница_справа_на_первых.png)
...
```
                                                                         value
Mean spread                                         1.314 ticks    (0.163 bps)
Std                                                                2.206 ticks
p50 / p75 / p90 / p95 / p99 / p99.9 (ticks)  1  /  1  /  1  /  2  /  10  /  26
Max                                                    201 ticks    (24.1 bps)
Skewness                                                                +21.43
Excess kurtosis                                                        +915.30
= 1 tick (% time)                                                      94.75 %
= 2 ticks                                                               1.00 %
≥ 5 ticks                                                              2.968 %
≥ 10 ticks                                                            1.0301 %
≥ 50 ticks  (extreme dislocation)                                     0.0267 %
AR(1) of spread_ticks                                                   +0.207
```
...
**Output:**
```
Stale (Δmid=0): 81.0%  |  Actual moves: 148,210  std=1.197 bps  kurt=65.9
```

![fig_04_snapshot_to_snapshot_returns_skip_stale_.png](fig_04_snapshot_to_snapshot_returns_skip_stale_.png)

```python
TICK = 0.001   # SOL-USDC perp minimum price increment
...
**Output:**
```
p50=5 ticks  p95=18  p99=32  max=421
```

![fig_05_tick_0001_sol_usdc_perp_minimum_price_in.png](fig_05_tick_0001_sol_usdc_perp_minimum_price_in.png)
...
**Output:**
```
1s returns: N=148,210  mean=-0.001 bps  std=1.197 bps  skew=+0.24  kurt=+65.92  Jarque–Bera p=0.00e+00
```
...
t_overview = pd.DataFrame({'value': [
    ...
    f'{taker["sz"].sum():,.0f} SOL',
    f'{v_buy:,.0f} SOL  ({v_buy/(v_buy+v_sell)*100:.1f}%)',
    f'{v_sell:,.0f} SOL  ({v_sell/(v_buy+v_sell)*100:.1f}%)',
    f'mean {taker["sz"].mean():.2f}   median {taker["sz"].median():.2f}   p99 {taker["sz"].quantile(0.99):.1f}',
]}, index=['Trades', 'Rate', 'Buys', 'Sells', 'Total volume', 'Buy volume', 'Sell volume', 'Trade size (SOL)'])
t_overview
```
...
```
                                                 value
Trades                                         492,267
Rate                             1.14 /sec   (68 /min)
Buys                                  233,836  (47.5%)
Sells                                 258,431  (52.5%)
Total volume                            15,815,627 SOL
Buy volume                      7,752,318 SOL  (49.0%)
Sell volume                     8,063,309 SOL  (51.0%)
Trade size (SOL)  mean 32.13   median 1.49   p99 508.5
```

### 4.2 Trade size distribution

```python
LIN_BIN_SOL = 0.5   # bucket width for linear-scale panel
...
lin_bins = np.arange(0, lin_cap + LIN_BIN_SOL, LIN_BIN_SOL)
...
fig = make_subplots(rows=1, cols=2,
  subplot_titles=['Log10 scale', f'Linear scale (bin={LIN_BIN_SOL} SOL, clipped p80={lin_cap:.1f})'])
...
fig.update_xaxes(title_text='size (SOL)',  row=1, col=2)
fig.update_layout(template=THEME, barmode='overlay', height=380,
  title='Trade size distribution — buy vs sell')
show(fig)
```

![fig_11_lin_bin_sol_05_bucket_width_for_linear_s.png](fig_11_lin_bin_sol_05_bucket_width_for_linear_s.png)
...
```
                                                                 value
Count                                                          492,266
Mean Δt                           877.6 ms      (λ̂ = 1.14 trades/sec)
Std                                                          2142.7 ms
p10                                                             0.0 ms
p50 (median)                                                    0.0 ms
p90                                                            2554 ms
p99                                                           10402 ms
p99.9                                              21510 ms  (21.51 s)
Max                                               199868 ms  (199.9 s)
Δt < 50 ms (back-to-back bursts)                               53.51 %
Δt > 1 sec  (notable gaps)                                     22.25 %
Δt > 10 sec (rare lulls)                                      1.0990 %
```
...
**Output:**
```
Taker legs: 492,267   →   unique events (by time_ms): 229,625   (46.6% — остальное — legs внутри одного MO)
33.79% of event Δt fall into [0, 500] ms  (N = 77,592)  λ̂_events = 0.53/sec
```
...
Усреднённые `sz` (объём в SOL) и `n` (число ордеров) по каждому из 20 уровней. Где сидит реальная масса ликвидности — у L1 или в глубине?
...
fig = make_subplots(rows=2, cols=1, shared_xaxes=True, row_heights=[0.5, 0.5],
    subplot_titles=['Avg size per level (SOL) — bids vs asks',
...
0       0  875.30  853.02   7.47   7.45         117.15         114.46
1       1  181.68  184.77   2.18   2.29          83.26          80.84
2       2  206.91  202.88   2.21   2.27          93.79          89.50
3       3  232.71  225.31   2.31   2.36         100.69          95.63
4       4  255.44  246.13   2.43   2.46         105.33         100.09
5       5  279.79  267.38   2.54   2.54         110.30         105.30
6       6  297.17  288.08   2.58   2.56         115.23         112.73
7       7  308.87  301.09   2.57   2.53         120.15         118.86
8       8  323.92  315.47   2.58   2.52         125.74         125.18
9       9  339.63  329.48   2.59   2.51         131.06         131.46
10     10  351.56  342.68   2.57   2.49         136.60         137.52
11     11  360.74  355.05   2.56   2.49         140.78         142.70
12     12  369.36  364.94   2.56   2.49         144.33         146.60
13     13  371.88  374.93   2.54   2.49         146.27         150.36
14     14  376.21  387.47   2.53   2.52         148.41         153.81
15     15  384.88  399.27   2.54   2.54         151.70         157.42
16     16  392.58  409.83   2.52   2.54         155.49         161.26
17     17  400.65  421.18   2.52   2.55         159.05         165.45
18     18  408.11  431.19   2.50   2.55         162.98         169.32
19     19  417.70  438.21   2.51   2.53         166.60         172.94
```
...
```
                       bid L1  ask L1
median # orders          6.00    6.00
mean # orders            7.47    7.45
p99 # orders            34.00   34.00
max # orders           159.00  147.00
median order sz (SOL)   78.46   80.00
```
...
**Output:**
```
% snapshots where best bid changed: 16.94%
% snapshots where best ask changed: 16.90%
% snapshots where either changed:   19.07%
```

**Result:**
```
                    value
Median lifetime    527 ms
Mean              2657 ms
p90               6987 ms
p99              31881 ms
Max               272.7 s
...
0      1s   0.779      6.3     2.39       19.0
1      5s   2.077     16.8     6.07       49.0
2     15s   3.776     30.5    10.79       87.0
3    1min   7.565     61.2    21.60      174.0
4    5min  17.382    140.9    51.78      421.0
```
...
0  500ms          0.00   0.26   1.89   50.6
1     1s          0.00   0.88   3.06   50.7
2     5s          0.37   3.16   8.52   75.9
3    30s          3.41  10.14  24.81  109.6
4   1min          5.69  15.49  35.71  109.6
```
...
Сколько реально стоит торговать SOL после rebate? `fee < 0` — top-tier maker rebate.
...
```
                                               value
Effective maker rate (volume-weighted)    -0.012 bps
Effective taker rate (volume-weighted)    +3.371 bps
Round-trip cost (maker+taker)             +3.360 bps
Maker fills with rebate (count)               69.3 %
Maker volume on rebate                        79.5 %
Avg rebate per maker fill               -0.0735 USDC
Avg taker fee                            0.8747 USDC
```
...
_req = urllib.request.Request(
    ...
    data=_json.dumps({'type': 'fundingHistory', 'coin': 'SOL',
...
fig.update_layout(template=THEME, height=420, showlegend=False,
    title='SOL-USDC perp funding rate & premium — Apr 2026')
show(fig)
```
...
# Cumulative funding on a +1 SOL long position
sol_price   = lobs['mid'].mean()
cum_usdc    = (fund['rate'] / 1e4 * sol_price).cumsum()   # USDC per SOL

fig = make_subplots(rows=1, cols=2,
    subplot_titles=['Funding rate distribution', 'Cumulative cost: +1 SOL long (USDC)'])
...
fig.update_layout(template=THEME, height=360, showlegend=False,
    title=f'Funding distribution & cumulative P&L for +1 SOL long over {len(fund)} hours')
show(fig)
```

**Output:**
```
Negative rate (shorts pay longs): 50.8% of hours
Below theoretical floor (0.00125 bps/hr): 51.2% of hours
Mean rate: -0.0130 bps/hr  = -0.313 bps/day
Mean premium: -4.89 bps  (persistently negative = mark < oracle)
```
...
Уникально для DEX — мы видим адреса всех контрагентов. Кто и в каких пропорциях торгует SOL.
...
user                                                                   
0x162cc7c861ebd0c06b3d72319201150482518185   16085    15038     1047   
0x61ceef212ff4a86933c69fb6aca2fe35d8f2a62b    6772     6772        0   
0x72cb918356c4f6d3f1b2e532928110ba6995f139    7657     4947     2710   
0x57dd78cd36e76e2011e8f6dc25cabbaba994494b   20197     7263    12934   
0x1c81fb7100276aef766092e16cfcf61097e97a5d    5313     5313        0   
0x7b7f72a28fe109fa703eeed7984f2a8a68fedee2   14033     7130     6903   
0xc029043cd00b80363130fa058818459a521842a1   41113    22079    19034   
0xf9109ada2f73c62e9889b45453065f0d99260a2d    6476      212     6264   
0x0a06ec6754b628be489b2c40bba20c8580392a7b    5626     3766     1860   
0x0622a2198712c9527817493553dca548f42e8088    5974     1130     4844   
0x1294ff538c184bdc4fc9fe5471b8cd324763b5b7    4284     2385     1899   
0x170a03a53fe05bf4ce6753cb0907d05e827bc3c6   32508    17761    14747   
0x023a3d058020fb76cca98f01b3c48c8938a22355    6719      203     6516   
0xbdb525a0755b92f2a546e5caf62ff60a8e770163    7489        0     7489   
0xd071d6d6ea52f5aa34b79e47f908ee48c8215837    4277        0     4277   
0xb4d6fe0f1504a55c65a986ef55b9148a6f0dae7a   15919       16    15903   
0xecb63caa47c7c4e77f60f1ce858cf28dc2b82b00   15054       40    15014   
0x687feda45b6847763f5bf5c01a2f6c1a3d727f5c    3614     3614        0   
0xf5d81a135f756ca16544e53c20fc20643ec3ad53   18788    17359     1429   
0x8f63c88fccae90c1f9eb8b447f830bce7b71dd74    4631       72     4559   

                                            maker_share_%  notional ($M)  \
