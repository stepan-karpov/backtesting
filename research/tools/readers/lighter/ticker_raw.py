"""Сырой поток строк JSON ticker из zst."""
...
class TickerReaderRaw:
    """
    Один или несколько .jsonl.zst с ticker — итерация по **строкам** подряд
    (в порядке файлов). Каждая строка = одно сообщение top-of-book;
    JSON не парсим — разбор делает основной TickerReader.
    """
